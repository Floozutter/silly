...
struct GCD {
	static const unsigned long long int value = GCD<b, a % b>::value;
};
template <unsigned long long int a>
struct GCD<a, 0> {
	static const unsigned long long int value = a;
};
...
template <unsigned int n>
struct QPIE {
	static const unsigned long long int num = (
		(2*n + 1) * QPI<n-1>::num
		+ QPI<n-1>::den * static_cast<unsigned long long int>(n % 2 ? -1 : 1)
	);
	static const unsigned long long int den = QPI<n-1>::den * (2*n + 1);
};
template <unsigned int n>
struct QPI {
	static const unsigned long long int num = (
	...
	static const unsigned long long int den = (
		QPIE<n>::den / GCD<QPIE<n>::num, QPIE<n>::den>::value
	);
};
template <>
struct QPI<0> {
	static const unsigned long long int num = 1;
	static const unsigned long long int	den = 1;
};
